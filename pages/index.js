          ...
          <form onSubmit={submit} className="rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <label className="flex items-start gap-2 text-sm text-slate-600">
              ...
              <span>
                ...
                предложений по выбранным услугам. <a href="#privacy" className="underline underline-offset-4">Политика
      ...
      <footer className="border-t">
        <div className="mx-auto max-w-6xl px-4 py-10 text-sm">
          ...
          <div id="privacy" className="mt-8 text-xs leading-relaxed text-slate-500">
            ...
            Мы обрабатываем персональные данные, указанные в форме, с целью подготовки коммерческого
            предложения и коммуникации по выбранным услугам. Правовым основанием является согласие
            субъекта персональных данных. Данные хранятся в защищённой CRM и/или в рамках
            инфраструктуры интеграций (например, n8n). Вы можете отозвать согласие, написав нам в
            Telegram. Полная версия политики и пользовательского соглашения будет доступна на домене
            aiemployee.by после публикации сайта.
          </div>
          <div className="mt-6 text-xs text-slate-500">
            © {new Date().getFullYear()} AIEmployee.by — биржа AI‑сотрудников. Все права защищены.
          </div>
        </div>
      </footer>
    </main>
