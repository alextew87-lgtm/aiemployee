  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Готовые роли ИИ для продаж, маркетинга и поддержки. Интеграции с Telegram, Instagram, WhatsApp и Битрикс24. Запуск 1–3 дня."
        />
        ...
        <meta
          ...
          content="Подключайте AI-сотрудников под ваши задачи. Запуск 1–3 дня."
        />
      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-slate-50 text-slate-900">
        ...
        <header className="sticky top-0 z-30 backdrop-blur bg-white/80 border-b">
          <div className="mx-auto max-w-6xl px-4 h-16 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="size-8 rounded-xl bg-slate-900 text-white grid place-items-center font-bold">
                AI
              </div>
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm">
              ...
              <a href="#pricing" className="hover:text-slate-900 text-slate-600">Тарифы</a>
              <a href="#lead" className="hover:text-slate-900 text-slate-600">Заявка</a>
            </nav>
            <a
              href="#lead"
              className="inline-flex items-center rounded-2xl bg-slate-900 text-white px-4 py-2 text-sm font-medium shadow-sm hover:opacity-90"
            >
              Начать
            </a>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="mt-8 flex gap-3">
                <a
                  href="#lead"
                  className="inline-flex items-center rounded-2xl bg-slate-900 text-white px-5 py-3 text-sm font-medium shadow-sm hover:opacity-90"
                >
                  Оставить заявку
                </a>
                <a
                  href="#catalog"
                  className="inline-flex items-center rounded-2xl border px-5 py-3 text-sm font-medium hover:bg-white"
                >
                  Посмотреть роли
                </a>
              </div>
              ...
              <div className="aspect-[4/3] w-full rounded-3xl border bg-white shadow-lg p-6">
                <div className="grid grid-cols-3 gap-3 text-xs">
                  <div className="rounded-xl border p-3">
                    <div className="font-medium">AI-Админ</div>
                    <div className="text-slate-500 mt-1">Ответы в Direct, сбор лидов</div>
                  </div>
                  <div className="rounded-xl border p-3">
                    <div className="font-medium">AI-Копирайтер</div>
                    <div className="text-slate-500 mt-1">Посты, баннеры, пресс-релизы</div>
                  </div>
                  <div className="rounded-xl border p-3">
                    <div className="font-medium">AI-CRM</div>
                    <div className="text-slate-500 mt-1">Задачи, статусы, напоминания</div>
                  </div>
                  <div className="rounded-xl border p-3 col-span-2">
                    <div className="font-medium">Интеграции</div>
                    <div className="text-slate-500 mt-1">Telegram • Instagram • WhatsApp</div>
                  </div>
                  <div className="rounded-xl border p-3">
                    <div className="font-medium">Запуск 1–3 дня</div>
                    <div className="text-slate-500 mt-1">Готовые шаблоны ролей</div>
                  </div>
                </div>
        ...
        <section id="catalog" className="mx-auto max-w-6xl px-4 py-16">
          <SectionTitle
            kicker="Каталог"
            title="Готовые роли AI для быстрого старта"
            subtitle="Выберите роль — мы адаптируем скрипты, подключим каналы и CRM, обучим на ваших данных."
          />
        ...
        <section id="how" className="mx-auto max-w-6xl px-4 py-16">
          <SectionTitle
            ...
            subtitle="Простой путь от заявки до первых результатов."
          />
        ...
        <section id="pricing" className="mx-auto max-w-6xl px-4 py-16">
          <SectionTitle
            kicker="Тарифы"
            title="Гибкая стоимость под задачи"
            subtitle="Стартовый пакет для пилота и расширенные планы для масштабирования. Цены примерные — финальную смету утвердим после диагностики."
          />
            ...
            {[
              {
                ...
                features: [
                  "1 роль AI",
                  "1 канал (Telegram/Instagram/WhatsApp)",
                  "Базовые скрипты",
                  "N8n-сценарий + подключение",
                ],
              },
              {
                name: "Pro",
              ...
              },
              {
                ...
                features: [
                  "5+ ролей AI",
                  "Мультиканальность, SLA",
                  "Модерация/ручной оверрайд",
                  "Аудит безопасности и PD",
                ],
              },
            ].map((p) => (
              <div key={p.name} className="rounded-2xl border bg-white p-6 flex flex-col">
                ...
                <a
                  href="#lead"
                  className="mt-6 inline-flex items-center rounded-2xl bg-slate-900 text-white px-4 py-2 text-sm font-medium self-start"
                >
                  Выбрать
                </a>
              </div>
        ...
        <section id="lead" className="mx-auto max-w-6xl px-4 py-16">
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <SectionTitle
              kicker="Заявка"
              title="Давайте подключим AI-сотрудника под ваши задачи"
              subtitle="Оставьте контакты — пришлём предложение в течение рабочего дня."
            />
            <form onSubmit={submit} className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <Field label="Комментарий / задачи">
                <textarea
                  ...
                  rows={4}
                  className="w-full rounded-xl border px-3 py-2 outline-none focus:ring-2 focus:ring-slate-300"
                  placeholder="Каналы, интеграции, KPI, сроки..."
                />
              </Field>
              <label className="flex items-start gap-2 text-sm text-slate-600">
                ...
                <span>
                  ...
                  предложений по выбранным услугам.{" "}
              ...
              <button
                type="submit"
                disabled={sending}
                className="mt-6 inline-flex items-center rounded-2xl bg-slate-900 text-white px-5 py-3 text-sm font-medium disabled:opacity-60"
              >
        ...
        <footer className="border-t">
          <div className="mx-auto max-w-6xl px-4 py-10 text-sm">
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6 md:justify-between">
              <div className="flex items-center gap-2">
                <div className="size-7 rounded-lg bg-slate-900 text-white grid place-items-center font-bold">
                  AI
                </div>
            ...
            <div id="privacy" className="mt-8 text-xs leading-relaxed text-slate-500">
              ...
              коммерческого предложения и коммуникации по выбранным услугам. Правовым
              основанием является согласие субъекта персональных данных. Данные хранятся в
              защищённой CRM и/или в рамках инфраструктуры интеграций (например, n8n). Вы
              можете отозвать согласие, написав нам в Telegram. Полная версия политики и
              пользовательского соглашения будет доступна на домене aiemployee.by после
              публикации сайта.
            </div>
            <div className="mt-6 text-xs text-slate-500">
              © {new Date().getFullYear()} AIEmployee.by — биржа AI-сотрудников. Все права
              защищены.
            </div>
          </div>
        </footer>
